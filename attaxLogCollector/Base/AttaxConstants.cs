...
namespace Assets.Scripts.Base.Ataxx {
    public class AttaxConstants {
        ...
        public static class GetBestMoveConst {
            ...
            public const int riskAversionFactor = 13; //12            
            public const int flipWeight = 25; 
            public const int centerWeightMultiplier = 1;            
        }
        public static class EvaluateHeuristicConst {

            public const int earlyMaterialWeight = 10;
            public const int lateMaterialWeight = 40;            

            public const int earlyMobilityWeight = 8;
            public const int lateMobilityWeight = 2;
        ...
        public static int GetDynamicCloneBonus(int totalPieces) {
            return totalPieces < ChipsCountConst.earlyGame ? AttaxConstants.GetBestMoveConst.earlyGameCloneBonus : AttaxConstants.GetBestMoveConst.lateGameCloneBonus;
        }

        public static int GetDynamicStabilityMult(int totalPieces) {
            return totalPieces > ChipsCountConst.lateGame ? 1 : EvaluateHeuristicConst.StabilityWeight;            
        }
